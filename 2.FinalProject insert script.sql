...
insert into Item
values
  (60,15,5,'Triangle','759*270','parturient montes, nascetur ridiculus mus. Proin vel nisl. Quisque','Olive','2010-01-09 22:46:46'),
  (1,28,16,'Rectangle','142*185','accumsan interdum','Ivory','2015-04-04 07:39:04'),
  (33,14,23,'Flat','828*238','molestie orci tincidunt adipiscing. Mauris molestie','Salmon','2018-04-23 10:10:22'),
  (41,13,9,'Flat','668*571','montes, nascetur ridiculus mus. Donec dignissim magna','Magenta','2012-05-28 21:52:35'),
  (40,8,23,'Rectangle','499*303','senectus et','Thistle','2010-06-08 12:19:46'),
  (22,28,9,'Triangle','562*754','sodales.','Gold','2011-04-27 09:00:25'),
  (30,14,21,'Triangle','190*719','aliquet odio. Etiam ligula tortor, dictum eu,','Salmon','2013-03-25 06:50:10'),
  (3,27,27,'Rectangle','205*104','quam vel','Tomato','2020-08-22 19:18:49'),
  (52,25,2,'Varying','699*829','eu nibh vulputate mauris sagittis placerat. Cras dictum','Magenta','2020-09-29 17:18:22'),
  (24,5,28,'Square','712*098','mus. Proin vel','Tomato','2011-07-27 10:06:23'),
  (47,8,6,'Oval','714*781','dapibus gravida. Aliquam tincidunt,','Magenta','2020-03-06 16:15:58'),
  (22,21,10,'Flat','108*239','tincidunt congue turpis.','Coral','2015-07-29 17:37:41'),
  (38,15,1,'Cone','980*781','sit amet, consectetuer adipiscing elit. Etiam laoreet,','Red','2018-03-16 16:26:35'),
  (45,10,2,'Cube','612*048','Fusce feugiat. Lorem ipsum dolor sit amet,','Orchid','2015-05-25 19:30:20'),
  (32,6,8,'Oval','834*533','egestas. Aliquam nec enim. Nunc ut','Bisque','2018-05-19 14:56:13'),
  (26,21,6,'Flat','452*735','aliquet odio. Etiam ligula tortor, dictum eu,','Orchid','2020-08-05 20:11:32'),
  (39,24,19,'Varying','940*742','nec tempus scelerisque, lorem ipsum sodales purus,','Coral','2015-07-12 08:57:20'),
  (26,7,9,'Cone','332*834','dui nec urna suscipit nonummy. Fusce fermentum fermentum','Red','2020-01-13 11:33:44'),
  (15,9,4,'Rectangle','128*243','varius. Nam porttitor scelerisque neque.','Thistle','2013-07-15 22:16:11'),
  (19,30,30,'Triangle','741*731','vitae semper egestas, urna justo faucibus lectus, a','Beige','2010-09-07 02:32:49'),
  (6,29,23,'Cube','164*973','faucibus id, libero. Donec consectetuer mauris','Snow','2013-11-01 18:23:03'),
  (37,4,23,'Triangle','442*559','feugiat metus sit amet ante.','Khaki','2010-05-30 10:11:44'),
  (40,6,23,'Square','872*575','pede, nonummy ut, molestie in,','Khaki','2012-08-02 00:36:27'),
  (3,11,2,'Oval','844*287','pretium neque. Morbi quis urna. Nunc quis arcu','Fuchsia','2019-10-01 16:58:46'),
  (50,26,17,'Triangle','421*328','orci lacus','Snow','2021-04-10 20:56:06'),
  (50,30,5,'Varying','370*172','non nisi. Aenean','Brown','2013-06-29 08:33:55'),
  (35,14,5,'Cone','131*528','Ut nec urna et arcu','Red','2018-02-04 21:33:48'),
  (58,11,6,'Cube','769*524','mattis. Integer eu lacus. Quisque imperdiet, erat nonummy ultricies','Peru','2021-01-25 19:36:33'),
  (34,3,17,'Rectangle','617*648','egestas, urna justo faucibus lectus, a sollicitudin orci sem','Thistle','2015-04-15 17:17:05'),
  (23,29,13,'Triangle','656*838','cursus et, magna. Praesent interdum ligula eu enim.','Ivory','2010-09-07 03:13:26'),
  (39,28,13,'Round','520*349','ante. Maecenas','Salmon','2020-07-20 22:42:35'),
  (27,25,23,'Cube','310*806','non, vestibulum nec, euismod in, dolor.','Plum','2020-08-08 22:13:19'),
  (35,28,17,'Oval','967*244','Ut sagittis lobortis mauris.','Gold','2012-12-01 00:15:11'),
  (13,8,14,'Cone','333*877','amet, consectetuer adipiscing elit. Etiam laoreet, libero et','Tan','2020-02-26 00:30:22'),
  (49,24,27,'Round','758*918','vitae sodales nisi magna sed dui.','Beige','2014-09-28 01:25:14'),
  (44,10,2,'Rectangle','635*304','nulla magna, malesuada vel, convallis','Black','2016-02-05 01:53:06'),
  (31,29,19,'Square','583*574','odio a purus. Duis','Ivory','2015-03-10 14:57:36'),
  (6,10,17,'Oval','342*422','eget mollis lectus pede et risus. Quisque libero lacus,','Gold','2021-01-13 14:38:40'),
  (53,20,10,'Square','141*281','Vivamus non lorem vitae odio sagittis semper. Nam tempor diam','Bisque','2021-10-28 12:40:45'),
  (24,1,3,'Oval','199*457','lobortis quis,','Thistle','2015-08-03 23:53:09'),
  (20,28,17,'Varying','732*476','In mi pede, nonummy','Pink','2020-11-18 17:49:44'),
  (5,6,10,'Triangle','126*463','eros turpis non','Lime','2020-07-17 00:06:14'),
  (29,4,20,'Oval','260*874','nisi dictum augue malesuada malesuada. Integer id magna','Thistle','2012-08-20 14:38:45'),
  (33,3,9,'Round','665*719','dignissim lacus. Aliquam rutrum lorem','Salmon','2016-10-20 20:34:33'),
  (16,17,7,'Triangle','274*657','aliquet, sem ut cursus luctus, ipsum leo elementum sem,','Gray','2020-04-23 01:29:56'),
  (24,14,19,'Triangle','511*834','consequat nec, mollis vitae, posuere at, velit. Cras lorem','Brown','2017-04-18 03:50:45'),
  (4,12,13,'Triangle','550*223','Sed molestie.','Black','2016-05-25 06:16:07'),
  (19,7,15,'Flat','088*322','Curabitur vel lectus. Cum sociis natoque penatibus et','Yellow','2020-11-29 04:38:21'),
  (43,21,5,'Round','242*858','cursus et, eros. Proin ultrices. Duis volutpat nunc sit amet','Ivory','2014-10-12 03:02:09'),
  (34,30,21,'Oval','692*654','at, iaculis quis, pede.','Bisque','2016-07-08 08:32:43'),
  (46,12,18,'Triangle','730*606','non lorem vitae odio sagittis semper.','Indigo','2021-09-11 20:08:32'),
  (57,25,24,'Square','871*711','Donec nibh. Quisque nonummy ipsum non arcu. Vivamus sit','Green','2012-08-17 11:30:01'),
  (5,23,30,'Rectangle','226*339','turpis non enim. Mauris quis turpis','Ivory','2014-12-14 17:15:50'),
  (43,5,12,'Triangle','151*108','cubilia Curae Donec tincidunt.','Orchid','2015-08-27 01:08:28'),
  (36,29,29,'Triangle','434*516','Aliquam fringilla cursus purus. Nullam scelerisque neque sed sem','Lime','2019-07-01 23:10:48'),
  (36,2,27,'Cube','757*338','massa rutrum magna. Cras convallis convallis dolor.','Silver','2020-07-01 10:21:45'),
  (30,18,29,'Cone','719*663','at pretium aliquet, metus urna convallis erat, eget tincidunt dui','Linen','2017-05-03 21:26:40'),
  (45,16,24,'Cone','027*084','ante ipsum primis in faucibus orci luctus','Khaki','2010-11-21 04:16:37'),
  (7,22,19,'Rectangle','356*154','in lobortis tellus justo sit','Navy','2014-02-23 20:13:28'),
  (52,17,19,'Flat','940*258','porttitor','Maroon','2018-10-09 01:25:14');
